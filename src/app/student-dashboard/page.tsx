...
import { Student, Exam, Result, getStudentTargets, getStudentScoreTarget, incrementStudentViewCount, getBransDenemesiSonuclariByStudent, getBransDenemeleri, BransDenemesiSonuc, BransDenemesi } from '../../firebase';
...
const BransDenemeleriTab = ({ studentId }: { studentId: string }) => {
  ...
  const loadStudentResults = async () => {
    setLoading(true);
    try {
      const results = await getBransDenemesiSonuclariByStudent(studentId);
